...
const base = `mintgaming@<span style="color: #b8d5ef">abc.xyz</span>:<span style="color: dodgerblue">~</span>$ `;
let array = [];
let input = "";
let lastIdx = -1;
let lastCmd = "";
...
function inputLine(k) {
	terminal.innerHTML += `\n<div class=\"new-line\">mintgaming@<span style=\"color: #b8d5ef\">abc.xyz</span>:<span style=\"color: dodgerblue\">~</span>$ ${k?k:""}</div>`
}
...
function info() {
	terminal.innerHTML += '\n<img alt="icon" class="img" src="static/icon.png">\n' + "  <div><span>mintgaming</span>@<span>outlook.com.vn</span></div>\n" + "  <div>---------------------</div>\n" + "  <div><span>OS</span>: Lunarix</div>\n" + "  <div><span>Ages</span>: 14</div>\n" + "  <div><span>Twitter</span>: <a href=\"https://twitter.com/iamchocomintosu\" target='_blank'>@iamchocomintosu</a></div>\n" + "  <div><span>Discord</span>: <a href=\"https://discord.com/users/329946665043623936\" target='_blank'>I am a BBcon#0727</a></div>\n" + "  <div><span>Youtube</span>: <a href=\"https://www.youtube.com/channel/UC6iD1OYmXHfuWubG4O1_W1w\" target='_blank'>iamchocomintosu.</a></div>\n" + "  <div><span>osu!</span>: <a href=\"https://osu.ppy.sh/users/20862514\" target='_blank'>mintgaming</a></div>\n" + "  <div><span>Me on Facebook</span>: <a href=\"https://www.facebook.com/chocomintee\" target='_blank'>Trần Thiên Minh</a></div>\n" + '  <div style="padding-bottom:10px; clear: both;">'
}